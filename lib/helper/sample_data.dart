...
class SampleData {
  /// Khôi phục loại cho bộ dữ liệu mẫu được tạo bởi các phiên bản cũ.
  ///
  /// Trước khi có 3 khu vực My Notes / Reminder / Shopping, các ghi chú mẫu
  /// đều được lưu với [noteType] = `note`. Chỉ các tiêu đề đặc trưng của bộ
  /// dữ liệu mẫu mới được đổi để không tự ý phân loại lại ghi chú do người
  /// dùng tạo. Danh sách trả về là các ghi chú vừa được cập nhật.
  static Future<List<Note>> restoreLegacySampleNoteTypes(Database db) async {
    const legacyTypes = <String, String>{
      'coding': 'reminder',
      'gaming': 'reminder',
      'shopping': 'reminder',
      'họp nhóm': 'reminder',
      'mua thịt bò': 'shopping',
      'mua cá': 'shopping',
      'rau củ': 'shopping',
      'trái cây': 'shopping',
    };
    const legacyContents = <String, String>{
      'coding': 'Hoàn thành bài tập Flutter trước 9h tối.',
      'gaming': 'Hẹn team chơi game lúc 8h.',
      'shopping': 'Đi siêu thị mua đồ cuối tuần.',
      'họp nhóm': 'Họp dự án lúc 14h chiều thứ Tư.',
      'mua thịt bò': '500g thịt bò để làm bún bò.',
      'mua cá': 'Cá basa hoặc cá hồi.',
      'rau củ': 'Cà rốt, cải xanh, hành lá.',
      'trái cây': 'Táo, cam, chuối cho cả tuần.',
    };
    ...
    for (final note in notes) {
      // Chỉ sửa bản ghi cũ đang bị mặc định là My Notes.
      if (note.noteType.isNotEmpty && note.noteType != 'note') continue;
      final intendedType = legacyTypes[normalize(note.title ?? '')];
      if (intendedType == null ||
          note.content?.trim() != legacyContents[normalize(note.title ?? '')]) {
        continue;
      }
      final updated = note.copyWith(
        noteType: intendedType,
  ...
  static Future<void> seedIfEmpty(Database db) async {
    ...
    DateTime ago(int h) =>
        now.subtract(Duration(hours: h, minutes: h * 7 % 60));
    ...
    final myNotes = <Note>[
      Note(
        ...
        title: 'SINH NHẬT CÁ',
        content:
            'Hôm đấy cả nhóm tụ tập ăn uống tới khuya, vui phết! Nhớ mang quà lần sau.',
        createdAt: ago(2),
        editedAt: ago(2),
      ...
      Note(
        ...
        title: 'ĐI ĐÀ LẠT',
        content:
            'Mệt nhưng mà cũng vui phết! Chuyến đi đáng nhớ với hội bạn thân.',
        createdAt: ago(5),
        editedAt: ago(5),
        isFavorite: true,
        folderId: folderIds['Ghi chú cá nhân'],
      ...
      Note(
        ...
        title: 'ĐI ĂN NƯỚNG',
        content:
            'Ngon thiệc! Quán nướng mới mở gần nhà, giá hợp lý, không gian ổn.',
        createdAt: ago(9),
        editedAt: ago(9),
      ...
      Note(
        ...
        title: 'PHƯỢT NÚI',
        content:
            'Săn mây trên đỉnh, cắm trại qua đêm. Nhớ mang theo áo ấm và đèn pin.',
        createdAt: ago(20),
        editedAt: ago(20),
        tagIds: [tagIds['Du lịch']!],
      ),
      Note(
        ...
        content:
            'Mỗi ngày 1 giờ tiếng Anh, 1 giờ lập trình. Cuối tuần ôn lại toàn bộ.',
        createdAt: ago(30),
        editedAt: ago(30),
        pinned: true,
      ...
      Note(
        ...
        title: 'PHIM CẦN XEM',
        content:
            'Danh sách phim hay bạn bè giới thiệu, để dành cuối tuần xem dần.',
        createdAt: ago(40),
        editedAt: ago(40),
        tagIds: [tagIds['Cá nhân']!],
      ),
    ...
    String checklist(List<List<Object>> items) =>
        jsonEncode(items.map((e) => {'text': e[0], 'done': e[1]}).toList());
    ...
    final reminderNotes = <Note>[
      Note(
        ...
        color: c[0].toARGB32(),
        title: 'coding',
        content: 'Hoàn thành bài tập Flutter trước 9h tối.',
        createdAt: ago(1),
        editedAt: ago(1),
        tagIds: [tagIds['Công việc']!],
      ),
      Note(
        ...
        color: c[3].toARGB32(),
        title: 'gaming',
        content: 'Hẹn team chơi game lúc 8h.',
        createdAt: ago(3),
        editedAt: ago(3),
      ),
      Note(
        ...
        color: c[2].toARGB32(),
        title: 'shopping',
        content: 'Đi siêu thị mua đồ cuối tuần.',
        createdAt: ago(6),
        editedAt: ago(6),
      ),
      Note(
        ...
        color: c[1].toARGB32(),
        title: 'họp nhóm',
        content: 'Họp dự án lúc 14h chiều thứ Tư.',
        createdAt: ago(12),
        editedAt: ago(12),
    ...
    final shoppingNotes = <Note>[
      Note(
        id: 0,
        noteType: 'shopping',
        color: NotePalette.shoppingPaper.toARGB32(),
        title: 'mua thịt bò',
        price: '30k',
        content: '500g thịt bò để làm bún bò.',
        createdAt: ago(1),
        editedAt: ago(1),
      ),
      Note(
      ...
      Note(
        id: 0,
        noteType: 'shopping',
        color: NotePalette.shoppingPaperAlt.toARGB32(),
        title: 'rau củ',
        price: '20k',
        content: 'Cà rốt, cải xanh, hành lá.',
        createdAt: ago(4),
        editedAt: ago(4),
      ),
      Note(
        ...
        title: 'trái cây',
        price: '50k',
        content: 'Táo, cam, chuối cho cả tuần.',
        createdAt: ago(7),
        editedAt: ago(7),
      ),
    ];
    ...
    final trashedId = await NoteDatabase.insertNote(
      ...
      Note(
        ...
        content:
            'Đây là ghi chú mẫu nằm trong thùng rác — bạn có thể khôi phục hoặc xóa hẳn.',
        createdAt: ago(72),
        editedAt: ago(72),
      ),
    );
